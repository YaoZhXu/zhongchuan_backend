...
(
    ...
    type         TINYINT UNSIGNED NOT NULL DEFAULT 1,                                             -- 文档类型
    ...
    create_by    VARCHAR(8)       NOT NULL DEFAULT 0,                                             -- 创建者ID
    create_time  DATETIME         NOT NULL DEFAULT CURRENT_TIMESTAMP,                             -- 创建时间
    update_by    VARCHAR(8)       NOT NULL DEFAULT 0,                                             -- 修改者ID
    update_time  DATETIME         NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, -- 修改时间
    PRIMARY KEY (id),
...
(
    ...
    title       TEXT         NOT NULL,                                                       -- 分片标题
    content     TEXT         NOT NULL,                                                       -- 分片内容
    pagination  INT UNSIGNED NOT NULL,                                                       -- 页码
...
INSERT INTO chunk(corpus_id, doc_id, title, content, pagination)
VALUES (3209847, 3209847, '中船规范',
